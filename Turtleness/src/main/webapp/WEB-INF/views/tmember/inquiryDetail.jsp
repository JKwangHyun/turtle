			...
			<table width=540>
				...
				<tr>	
					...
					<td>
						...
						<input type="text" id="title" value="${Inquiry.title}" name="title" style="width:425px;">
					</td>
				</tr>
				<tr height="10"></tr>
				<tr>
				...
				<tr>
					<td colspan="2">
						<textarea cols="80" rows="15" id="content"  name="content">${Inquiry.content}</textarea>
					</td>
				</tr>
				<tr height="20"></tr>
				<tr align="center">
					<td colspan="2">
						<input type="button" value="수정" onclick="inquiryUpdate()" style="width:133px;height:30px; font-size:15px; color:white;background-color:black;border-radius:20px;border:0;">
